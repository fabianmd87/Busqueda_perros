...
$query = "SELECT pp.imagen, pp.nombre as nombre, r.descripcion as raza, b.descripcion as barrio, pp.contacto as contacto, pp.sexo as sexo,  pp.id, u.id as id_usuario
FROM perros_perdido pp
INNER JOIN raza r ON r.id = pp.id_raza
INNER JOIN barrio b ON b.id = pp.id_barrio
INNER JOIN usuario u ON u.id = pp.id_usuario
ORDER BY pp.id ASC";
  ...
  <body>    
	...
	<?php 
		...
		<div class="row" style="margin-top:15px">
			...
			?>
			<form method="POST" action="agregar_perros.php">
				<br>
				<div class="col-xl-4">
					  ...
					  <div class="card-body">
						...
						if( isset($_SESSION['id_usuario'])){	
							...
							<input type="submit" name="btnEliminar" class="btn btn-danger" onclick="return confirm('Desea eliminar el perro perdido?');" value="Eliminar">
