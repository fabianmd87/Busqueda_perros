...
$query = "SELECT pe.imagen, pe.apodo as apodo, r.descripcion as raza, b.descripcion as barrio, pe.contacto as contacto, pe.sexo as sexo,  pe.id, u.id as id_usuario
FROM perros_encontrados pe
INNER JOIN raza r ON r.id = pe.id_raza
INNER JOIN barrio b ON b.id = pe.id_barrio
INNER JOIN usuario u ON u.id = pe.id_usuario
ORDER BY pe.id ASC";
  ...
  <body>    
	...
	<?php 
			...
			<div class="container">
				<div class="row">	
					<div class="mx-auto">
						<a href="Agregar_perros_encontrados.php">
		...
		<div class="row" style="margin-top:15px">
			...
			?>
			<form method="POST" action="Agregar_perros_encontrados.php">
				<br>
				<div class="col-xl-4">
					  ...
					  <div class="card-body">
						...
						if( isset($_SESSION['id_usuario'])){	
							...
							<input type="submit" name="btnEliminar" class="btn btn-danger" onclick="return confirm('Desea eliminar el perro encontrado?');" value="Eliminar">
