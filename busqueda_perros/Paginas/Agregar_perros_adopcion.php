...
if(isset($_POST["btnEliminar"]))
  {
    ...
    $queryEliminar = "DELETE FROM perros_adopcion WHERE id=".$_POST["id_perro"];
...
if(isset($_POST["id_perro"])){
 ...
 /*Si estas editando*/
  $queryEdit = "SELECT * FROM perros_adopcion WHERE id =".$_POST["id_perro"];
  $resultado_editar = $mysqli->query($queryEdit);
  $fila_editar = $resultado_editar->fetch_object();

  $edad = $fila_editar->edad;
...
<body>
  ...
  <form method="POST" enctype="multipart/form-data" action="../modelos/guardarPerroAdopcion.php">
      ...
      <div class="row"  style="margin-left: 5px">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <a href="perros_adopcion.php"><input type="button" class="btn btn-primary ribbon" value="VOLVER" name="btnAgregar"></a>
