...
if(isset($_POST["btnEliminar"]))
  {
    ...
    $queryEliminar = "DELETE FROM perros_encontrados WHERE id=".$_POST["id_perro"];
...
if(isset($_POST["id_perro"])){
 ...
 /*Si estas editando*/
  $queryEdit = "SELECT * FROM perros_encontrados WHERE id =".$_POST["id_perro"];
  $resultado_editar = $mysqli->query($queryEdit);
  $fila_editar = $resultado_editar->fetch_object();

  $apodo = $fila_editar->apodo;
...
<body>
  ...
  <form method="POST" enctype="multipart/form-data" action="../modelos/guardarPerroEncontrado.php">

    <div class="row">

      <div class="col-md-4"></div>
      <div class="col-md-3">
         <h3 class="text-center">PERROS ENCONTRADOS</h3>
      </div>
      ...
      <div class="row"  style="margin-left: 2px">
        ...
        <div class="col-md-3">
          ...
          <h5>APODO</h5>
           ...
           <input type="text" name="apodo" class="form-control" placeholder="" value= <?php echo $apodo ?>>
      ...
      <div class="row"  style="margin-left: 5px">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <a href="perros_encontrados.php"><input type="button" class="btn btn-primary ribbon" value="VOLVER" name="btnAgregar"></a>
